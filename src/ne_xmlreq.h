 ...
 * returned. */
NE_API int ne_xml_parse_response(ne_request *req, ne_xml_parser *parser);
...
NE_API int ne_xml_dispatch_request(ne_request *req, ne_xml_parser *parser);
...
NE_API int ne_xml_dispatchif_request(ne_request *req, ne_xml_parser *parser,
