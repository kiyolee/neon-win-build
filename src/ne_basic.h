...
NE_API int ne_get(ne_session *sess, const char *path, int fd);
...
NE_API int ne_getbuf(ne_session *sess, const char *path,
...
NE_API int ne_mkcol(ne_session *sess, const char *path);

/* Adds a Depth: header to a request. */
NE_API void ne_add_depth_header(ne_request *req, int depth);
...
NE_API int ne_getmodtime(ne_session *sess, const char *path, time_t *modtime);
...
NE_API int ne_get_content_type(ne_request *req, ne_content_type *ctype);
...
NE_API int ne_options2(ne_session *sess, const char *path, unsigned int *caps);
