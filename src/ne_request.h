 ...
 * Ignores userdata. */
NE_API int ne_accept_2xx(void *userdata, ne_request *req, const ne_status *st);

/* An acceptance callback which accepts all responses.  Ignores
 * userdata. */
NE_API int ne_accept_always(void *userdata, ne_request *req, const ne_status *st);
 ...
 * request. */
NE_API const char *ne_get_response_trailer(ne_request *req, const char *name)
    ne_attribute((nonnull));
...
NE_API void *ne_response_trailer_iterate(ne_request *req, void *cursor,
                                  const char **name, const char **value);
...
NE_API const ne_uri *ne_get_request_target(ne_request *req)
    ne_attribute((nonnull));
 ...
 * present. */
NE_API ne_uri *ne_get_response_location(ne_request *req, const char *fragment)
...
NE_API time_t ne_get_response_retry_after(ne_request *req)
    ne_attribute((nonnull (1)));
 ...
 * ne_get_status(). */
NE_API int ne_request_dispatch(ne_request *req) ne_attribute((nonnull (1)));
 ...
 * above. */
NE_API int ne_begin_request(ne_request *req);
NE_API int ne_end_request(ne_request *req);
 ...
 */
NE_API ssize_t ne_read_response_block(ne_request *req, char *buffer, size_t buflen);
...
NE_API int ne_read_response_to_buffer(ne_request *req, char *buf, size_t *buflen)
    ne_attribute((nonnull));
...
NE_API void ne_set_request_flag(ne_request *req, ne_request_flag flag, int value);
...
NE_API void ne_hook_close_conn(ne_session *sess, ne_close_conn_fn fn, void *userdata);
