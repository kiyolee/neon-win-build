 ...
 */
NE_API ne_ssl_client_cert *ne_ssl_clicert_fromuri(const char *uri,
                                           unsigned int flags);
...
NE_API ne_ssl_client_cert *ne_ssl_clicert_copy(const ne_ssl_client_cert *ccert);
...
NE_API const char *ne_ssl_proto_name(enum ne_ssl_protocol proto);
...
NE_API void ne_ssl_context_trustdefca(ne_ssl_context *ctx);
...
NE_API void ne_ssl_context_set_clicert(ne_ssl_context *ctx, const ne_ssl_client_cert *cc);
...
NE_API void ne_ssl_context_set_ccprovide(ne_ssl_context *ctx,
...
NE_API int ne_ssl_context_set_versions(ne_ssl_context *ctx, enum ne_ssl_protocol min,
